 ...
 *
 * <p>Implementations must perform <b>lazy expiry cleanup</b> inside both {@code get} and {@code
 * put} so that stale entries are never returned and do not consume capacity unnecessarily.
 */
public interface Cache<K, V> {
   ...
   *
   * @param ttlMs positive milliseconds after which this entry is considered stale; {@code ≤ 0}
   *     means no expiry
   */
