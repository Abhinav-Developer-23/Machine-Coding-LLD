...
/**
 * SeatLockProvider (Concrete implementation of ISeatLockProvider)
 *
 * <p>Manages seat locks in the application's memory using a Map to store lock information,
 * associating shows and seats with the user who locked them and the lock's expiration time.
 *
 * <p>Suitable for scenarios where persistence of locks across application restarts is not required.
 * Note: Other Lock Providers can be Third Party Lock Providers or another algorithmic lock
 * providers.
 */
