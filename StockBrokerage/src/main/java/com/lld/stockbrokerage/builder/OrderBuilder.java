package com.lld.stockbrokerage.builder;

import com.lld.stockbrokerage.enums.OrderType;
import com.lld.stockbrokerage.enums.TransactionType;
...
import com.lld.stockbrokerage.strategy.LimitOrderStrategy;
import com.lld.stockbrokerage.strategy.MarketOrderStrategy;
  ...
  public Order build() {
    return new Order(
        ...
        type == OrderType.MARKET
            ...
            : new LimitOrderStrategy(transactionType),
        user);
  }
}
